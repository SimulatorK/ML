Assignment_1.py can be run either from the command line by calling "python assignment_1.py" from the "Assignment1" folder or run from an IDE. No inputs or arguments are required.
